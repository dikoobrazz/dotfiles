...
let s:palette.green = [151, '#89aabb']
...
call s:hi('DiffAdd', s:palette.green, s:palette.black, '')
call s:hi('DiffAdded', s:palette.blue, s:palette.black, '')
...
call s:hi('FoldColumn', s:palette.blue, s:palette.black, 'none')
