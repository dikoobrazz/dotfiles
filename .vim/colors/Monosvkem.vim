...
" Last Updated: Thu 18 Jun 2020 06:41:57 PM CEST
...
if (has('termguicolors') && &termguicolors) || has('gui_running')
  if &background ==# 'dark'
    ...
    hi DiffAdd guifg=#080808 guibg=#20bbfc guisp=NONE gui=reverse cterm=reverse
    ...
    hi String guifg=#5688af guibg=#080808 guisp=NONE gui=NONE cterm=NONE
  ...
  if get(g:, 'Monosvkem_transp_bg', 0) && !has('gui_running')
    hi Normal guifg=#080808 guibg=NONE guisp=NONE gui=NONE cterm=NONE
    hi Terminal guifg=#080808 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  else
    hi Normal guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
    hi Terminal guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  endif
  ...
  hi CursorLineNr guifg=#080808 guibg=#eeeeee guisp=NONE gui=NONE cterm=NONE
  hi DiffAdd guifg=#94d697 guibg=#080808 guisp=NONE gui=reverse cterm=reverse
  hi DiffChange guifg=#b4b6d7 guibg=#080808 guisp=NONE gui=reverse cterm=reverse
  hi DiffDelete guifg=#d49697 guibg=#080808 guisp=NONE gui=reverse cterm=reverse
  hi DiffText guifg=#d496d7 guibg=#080808 guisp=NONE gui=reverse cterm=reverse
  hi Directory guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  hi EndOfBuffer guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  hi ErrorMsg guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=reverse cterm=reverse
  hi FoldColumn guifg=#606060 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  hi Folded guifg=#606060 guibg=#d7d7d7 guisp=NONE gui=italic cterm=italic
  hi IncSearch guifg=#fcbb20 guibg=#080808 guisp=NONE gui=reverse cterm=reverse
  ...
  hi ModeMsg guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=bold cterm=bold
  hi MoreMsg guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  hi NonText guifg=#606060 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  hi Pmenu guifg=#080808 guibg=#b4b6d7 guisp=NONE gui=NONE cterm=NONE
  hi PmenuSbar guifg=#080808 guibg=#606060 guisp=NONE gui=NONE cterm=NONE
  hi PmenuSel guifg=#080808 guibg=#d496d7 guisp=NONE gui=NONE cterm=NONE
  hi PmenuThumb guifg=#080808 guibg=#d496d7 guisp=NONE gui=NONE cterm=NONE
  hi Question guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  hi Search guifg=#20bbfc guibg=#080808 guisp=NONE gui=reverse cterm=reverse
  hi SignColumn guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  hi SpecialKey guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  ...
  hi StatusLine guifg=#eeeeee guibg=#080808 guisp=NONE gui=bold cterm=bold
  hi StatusLineNC guifg=#080808 guibg=#eeeeee guisp=NONE gui=NONE cterm=NONE
  hi String guifg=#0056b7 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  hi TabLine guifg=#080808 guibg=#eeeeee guisp=NONE gui=NONE cterm=NONE
  hi TabLineFill guifg=#080808 guibg=#eeeeee guisp=NONE gui=NONE cterm=NONE
  hi TabLineSel guifg=#eeeeee guibg=#080808 guisp=NONE gui=bold cterm=bold
  hi Title guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  ...
  hi WarningMsg guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  hi WildMenu guifg=#080808 guibg=#eeeeee guisp=NONE gui=NONE cterm=NONE
  hi Comment guifg=#bbbbbb guibg=#080808 guisp=NONE gui=reverse cterm=reverse
  hi Constant guifg=#080808 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Error guifg=#ff2040 guibg=#080808 guisp=NONE gui=bold,reverse cterm=bold,reverse
  hi Identifier guifg=#080808 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Ignore guifg=#080808 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi PreProc guifg=#080808 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Special guifg=#aa053b guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Statement guifg=#080808 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Todo guifg=#20fcbb guibg=#080808 guisp=NONE gui=bold,reverse cterm=bold,reverse
  hi Type guifg=#080808 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  hi Underlined guifg=#080808 guibg=NONE guisp=NONE gui=underline cterm=underline
  hi CursorIM guifg=#080808 guibg=#bbfc20 guisp=NONE gui=NONE cterm=NONE
  hi ToolbarLine guifg=NONE guibg=#d7d7d7 guisp=NONE gui=NONE cterm=NONE
  hi ToolbarButton guifg=#080808 guibg=#d7d7d7 guisp=NONE gui=bold cterm=bold
  hi markdownH1 guifg=#080808 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi markdownH2 guifg=#080808 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi markdownH3 guifg=#080808 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi markdownH4 guifg=#080808 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi markdownH5 guifg=#080808 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi markdownH6 guifg=#080808 guibg=NONE guisp=NONE gui=bold cterm=bold
  ...
  hi markdownUrl guifg=#606060 guibg=NONE guisp=NONE gui=NONE cterm=NONE
  ...
  hi markdownBold guifg=#080808 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi markdownItalic guifg=#080808 guibg=NONE guisp=NONE gui=italic cterm=italic
  hi markdownBoldItalic guifg=#080808 guibg=NONE guisp=NONE gui=bold,italic cterm=bold,italic
  ...
  hi rstSections guifg=#080808 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi rstEmphasis guifg=#080808 guibg=NONE guisp=NONE gui=italic cterm=italic
  hi rstStrongEmphasis guifg=#080808 guibg=NONE guisp=NONE gui=bold cterm=bold
  ...
  hi diffFile guifg=#080808 guibg=NONE guisp=NONE gui=bold cterm=bold
  hi diffAdded guifg=#080808 guibg=#94d697 guisp=NONE gui=NONE cterm=NONE
  hi diffRemoved guifg=#080808 guibg=#d49697 guisp=NONE gui=NONE cterm=NONE
  hi diffLine guifg=#080808 guibg=#b4b6d7 guisp=NONE gui=NONE cterm=NONE
  if !s:italics
    hi Folded gui=NONE cterm=NONE
    hi markdownItalic gui=NONE cterm=NONE
    hi markdownBoldItalic gui=bold cterm=bold
...
if s:t_Co >= 256
  if &background ==# 'dark'
    ...
    hi String ctermfg=67 ctermbg=232 cterm=NONE
  ...
  hi TabLineFill ctermfg=232 ctermbg=255 cterm=NONE
  ...
  hi WildMenu ctermfg=232 ctermbg=255 cterm=NONE
  hi Comment ctermfg=250 ctermbg=232 cterm=reverse
  ...
  hi diffFile ctermfg=232 ctermbg=NONE cterm=bold
  hi diffAdded ctermfg=232 ctermbg=114 cterm=NONE
  hi diffRemoved ctermfg=232 ctermbg=174 cterm=NONE
  hi diffLine ctermfg=232 ctermbg=146 cterm=NONE
  if !s:italics
    hi Folded cterm=NONE
    hi markdownItalic cterm=NONE
    hi markdownBoldItalic cterm=bold
