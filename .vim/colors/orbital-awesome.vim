...
if &t_Co >= 256 || has("gui_running")
    ...
    hi Comment  ctermbg=bg ctermfg=59 cterm=NONE guibg=bg guifg=#5f5f5f gui=italic
    ...
    hi Identifier ctermbg=bg ctermfg=246 cterm=NONE guibg=bg guifg=#949494 gui=bold
