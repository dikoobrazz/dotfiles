...
if &t_Co >= 256 || has("gui_running")
    ...
    hi Comment  ctermbg=bg ctermfg=59 cterm=NONE guibg=bg guifg=bg gui=italic
    hi Constant ctermbg=bg ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi Error ctermbg=20 ctermfg=223 cterm=NONE guibg=#0000d7 guifg=#ffd7af gui=bold
    ...
    hi Special ctermbg=bg ctermfg=180 cterm=NONE guibg=bg guifg=#d7af87 gui=italic
    hi Statement ctermbg=bg ctermfg=32 cterm=NONE guibg=bg guifg=#0087d7 gui=NONE
    hi String ctermbg=235 ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=italic
    ...
    hi Underlined ctermbg=235 ctermfg=137 cterm=NONE guibg=bg guifg=#af875f gui=NONE
    hi StatusLine ctermbg=bg ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    hi StatusLineNC ctermbg=bg ctermfg=235 cterm=NONE guibg=bg guifg=bg gui=NONE
    hi! link StatusLineTerm StatusLine
    hi! link StatusLineTermNC StatusLineNC
    hi VertSplit ctermbg=bg ctermfg=235 cterm=NONE guibg=bg guifg=bg gui=NONE
    hi TabLine ctermbg=bg ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi TabLineFill ctermbg=235 ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    ...
    hi CursorLine ctermbg=235 ctermfg=NONE cterm=NONE guibg=bg guifg=NONE gui=NONE
    ...
    hi Pmenu ctermbg=235 ctermfg=246 cterm=NONE guibg=bg guifg=#949494 gui=NONE
    hi PmenuSbar ctermbg=bg ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi PmenuSel ctermbg=235 ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi PmenuThumb ctermbg=bg ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi FoldColumn ctermbg=bg ctermfg=235 cterm=NONE guibg=bg guifg=bg gui=NONE
    ...
    hi DiffAdd ctermbg=235 ctermfg=223 cterm=NONE guibg=bg guifg=#ffd7af gui=NONE
    hi DiffChange ctermbg=235 ctermfg=246 cterm=NONE guibg=bg guifg=#949494 gui=NONE
    hi DiffDelete ctermbg=bg ctermfg=20 cterm=NONE guibg=bg guifg=#0000d7 gui=NONE
    hi DiffText ctermbg=235 ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    ...
    hi ColorColumn ctermbg=bg ctermfg=235 cterm=NONE guibg=bg guifg=bg gui=NONE
    ...
    hi CursorColumn ctermbg=235 ctermfg=NONE cterm=NONE guibg=bg guifg=NONE gui=NONE
    ...
    hi VimIsCommand ctermbg=235 ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    ...
    hi VimSubstRep4 ctermbg=235 ctermfg=25 cterm=NONE guibg=bg guifg=#005faf gui=NONE
    hi VimMapLhs ctermbg=235 ctermfg=254 cterm=NONE guibg=bg guifg=#e4e4e4 gui=NONE
    hi javaScriptObjectKey ctermbg=bg ctermfg=110 cterm=NONE guibg=bg guifg=#87afd7 gui=NONE
    hi javaScriptFunctionKey ctermbg=235 ctermfg=180 cterm=NONE guibg=bg guifg=#d7af87 gui=NONE
